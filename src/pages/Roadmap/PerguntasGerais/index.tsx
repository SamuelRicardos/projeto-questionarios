    ...
    return (
        <div
            className={`${theme === "dark" ? "bg-zinc-900 text-white" : "bg-white text-black"
                } transition-all duration-300 min-h-screen flex items-center justify-center px-4`}
        >
            <div
                className={`w-full max-w-4xl rounded-2xl shadow-lg p-8 space-y-10 ${theme === "dark" ? "bg-zinc-800" : "bg-white border border-gray-200"
                    }`}
            >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center gap-4">
                    <div className="relative w-full">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 bg-white text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:border-zinc-600 dark:bg-zinc-700 dark:text-white dark:placeholder-gray-400 dark:focus:ring-blue-400 dark:focus:border-blue-400 transition-colors"
                            required
                        />
                    </div>
                    <button
                        type="submit"
                        className="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-colors w-full sm:w-auto cursor-pointer"
                    >
                        Começar
                    </button>
                </form>
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <button
                                        ...
                                        className={`cursor-pointer rounded-full transition p-2 ${theme === "dark"
                                                ? "bg-zinc-700 hover:bg-zinc-600 text-white shadow-md"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {topicosRecentes.map((item, index) => (
                                <div
                                    ...
                                    className={`flex items-center justify-between p-4 cursor-pointer rounded-xl transition ${theme === "dark"
