    ...
    <>
      ...
      <main
        className={`w-full h-full transition-colors duration-300 ${
          theme === "dark" ? "bg-gray-800 text-white" : "bg-[#faf7ed] text-gray-800"
        }`}
      >
        <section className="w-full h-[89.9vh] max-w-[1500px] overflow-hidden flex justify-center relative">
          ...
          <div className="sm:hidden text-center flex flex-col items-center justify-center h-full p-4">
            ...
            <button
              className={`px-4 py-2 font-bold mt-5 border border-gray-300 rounded-lg cursor-pointer ${
                theme === "dark" ? "bg-gray-700 text-white" : "bg-[#D9D9D9] text-gray-800"
              }`}
            >
              Comece agora!
            </button>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-[1200px] w-full px-4">
            {[
              ...
              <div
                key={index}
                className={`p-6 rounded-lg flex flex-col items-center shadow-md transition-transform transform hover:-translate-x-3 hover:-translate-y-3 hover:shadow-lg ${
                  theme === "dark" ? "bg-gray-700 text-white" : "bg-[#faf7ed] text-gray-800"
                }`}
              >
                {item.icon}
